...
save stata\county_panel_try.dta, replace
...
local site_sum_var "emple reven salesforce mobile_workers sicgrp cyber_sum pcs it_budget hardware_budget software_budget services_budget vpn_pres idaccess_sw_pres dbms_pres datawarehouse_sw_pres security_sw_pres"
...
by county: replace ordermonth1 = ordermonth1[_n-1] if ordermonth1 ==.

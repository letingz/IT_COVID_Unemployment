...
eststo: areg initclaims_rate_regular tre tre##q4_high_its_emps  i.week, absorb(county) rob
estadd local tfixed "YES"
estadd local hfixed "YES"
...
esttab  _all using "`filename'", a keep(tre 1.tre#*1.q4_high_its_emps  1.tre#c.ln_pop `con'  )
		title(3. )
		order(tre 1.tre#*1.q4_high_its_emps  1.tre#c.ln_pop `con' )
		label stat( r2 N df_a tfixed hfixed,
		fmt( %9.3f %9.0g %9.0g) labels( R-squared Observations "No. Counties" "Week FE" "County FE"))
		 b(3) nogap onecell 
		nonotes addnote("Notes: Robust standard errors are in parentheses" "`starnote'")
